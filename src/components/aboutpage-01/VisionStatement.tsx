      ...
      <div className="main-container space-y-14 md:space-y-[70px]">
        <div className="space-y-3 text-center max-w-[780px] mx-auto">
          ...
          <RevealAnimation delay={0.3}>
            <h2>OceanSmart: AI-Driven, Arabic-First Business Platform</h2>
          </RevealAnimation>
          <RevealAnimation delay={0.4}>
            <p>
              OceanSmart is a bilingual platform offering smart invoicing, Oman VAT automation, 
              and real-time analytics — helping SMEs streamline finances. Simplify your workflow 
              and prepare for growth today.
            </p>
          </RevealAnimation>
        </div>
