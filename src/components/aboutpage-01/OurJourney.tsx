...
// import profitChartImg from '@public/images/home-page-8/profit-chart.png';
// import profitDarkChartImg from '@public/images/home-page-8/profit-dark-chart.png';
import Image from 'next/image';
import RevealAnimation from '../animation/RevealAnimation';

const featureList = [
  { id: 1, icon: 'ns-shape-8', label: ' Smart Invoicing', description: 'Launch with VAT-compliant invoicing, QR codes, and automated payment tracking.' },
  { id: 2, icon: 'ns-shape-9', label: ' Analytics & Growth', description: 'Add dashboards, financial reports, and business insights for smarter decisions.' },
  { id: 3, icon: 'ns-shape-12', label: ' AI Integration', description: 'Implement AI for automated reminders, cash flow forecasts, and smart suggestions.'},
        ...
        <div className="flex flex-col md:flex-row justify-between gap-y-10 gap-x-12 items-center">
          <div>
            <RevealAnimation delay={0.1}>
              <span className="badge badge-cyan mb-5">Our Journey</span>
            </RevealAnimation>
            ...
            <RevealAnimation delay={0.4}>
              <p className="lg:max-w-[536px]">
               Explore OceanSmart’s phased roadmap — designed to deliver an AI-powered, 
               bilingual platform that simplifies accounting and boosts growth for Omani SMEs. Coming soon!
              </p>
            </RevealAnimation>
                ...
                <RevealAnimation key={item.id} delay={0.5 + idx * 0.1}>
                  <li className="flex items-center gap-4 list-none py-2">
                    <span className={`${item.icon} text-[36px] text-secondary dark:text-accent`} />
                      <div>
                            <strong className="text-tagline-1 font-semibold text-secondary dark:text-accent">
                              {item.label}
                            </strong>
          ...
          <div className="relative max-w-[460px] min-h-[400px] md:min-h-[450px] lg:min-h-[500px] xl:min-h-[558px] max-h-[598px] w-full h-full bg-linear-[156deg,_#FFF_32.92%,_#83E7EE_91%] dark:bg-linear-[156deg,_#070B10_32.92%,_#C6F56F_91%] rounded-[20px]">
            ...
            <RevealAnimation delay={0.6} duration={1} direction="right" offset={100}>
              <figure className="absolute bottom-[5%] shadow-3 -right-2.5 md:-right-[4%] lg:-right-[2%] 2xl:-right-[20%] rounded-[20px] overflow-hidden max-w-[270px] lg:max-w-[330px] xl:max-w-[395px] w-full">
                <Image src='' alt="transaction-statistics (790x328)" className="block dark:hidden size-full" />
                <Image src='' alt="transaction-statistics (790x328)" className="hidden dark:block size-full" />
              </figure>
            </RevealAnimation>
          </div>
        </div>
