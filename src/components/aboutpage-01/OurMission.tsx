        ...
        <div className="flex items-center flex-wrap lg:flex-nowrap gap-8 lg:gap-4 xl:gap-8">
          <div className="w-full lg:w-1/2">
            <RevealAnimation delay={0.1}>
              <span className="badge badge-cyan mb-5">{t('about.badge', 'Why OceanSmart')}</span>
            </RevealAnimation>
            <div className={`space-y-3 md:max-w-[540px] ${isRTL ? 'text-right' : 'text-left'}`}>
              <RevealAnimation delay={0.2}>
                <h2>{t('about.title', 'Streamline your Arabic invoicing and grow faster.')}</h2>
              </RevealAnimation>
              <RevealAnimation delay={0.3}>
                <p>
                  {t('about.description', 'OceanSmart is the all-in-one platform for invoicing, VAT, and analytics. Automate billing, ensure tax compliance, and gain insights — tailored for Oman\'s SMEs and startups.')}
                </p>
              </RevealAnimation>
            </div>
          </div>
            ...
            <div className="w-full lg:w-1/2 max-w-[650px] rounded-[20px] bg-background-2 dark:bg-background-5 p-5 md:p-8 xl:p-[50px]">
              <div className="flex gap-4 sm:gap-2.5 flex-wrap sm:flex-nowrap">
                <div className="bg-white dark:bg-background-8 p-6 rounded-2xl w-full sm:w-[55%]">
                  <h5 className="mb-4">
                    {t('about.createInvoice', 'Create Invoice')}
                  </h5>
                  <div className="flex items-center gap-4 mb-7">
                    ...
                    <div>
                      <h5 className="text-secondary text-[16px] dark:text-accent">{t('about.draftInvoices', 'Draft bilingual invoices')}</h5>
                      <p className="text-secondary/60 text-sm dark:text-accent/60">{t('about.readyToShare', 'Ready to share with clients')}</p>
                    </div>
                  </div>
                  <div className="w-full h-[1px] bg-secondary/10 dark:bg-accent/10 mb-7" />
                  <div className="flex items-center justify-between">
                    <p className="text-secondary/60 dark:text-accent/60 text-tagline-2 font-medium">{t('about.timeAgo', '1 days Ago')}</p>
                ...
                <div className="bg-white dark:bg-background-8 p-6 rounded-2xl w-full sm:w-[45%]">
                  <h5 className="mb-4">{t('about.trackPayments', 'Track Payments')}</h5>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-start gap-5 p-6 rounded-2xl bg-secondary dark:bg-background-6 max-w-[370px] mt-2.5 z-10 relative">
                ...
                <div>
                  <h6 className="text-accent mb-1">Finance Assistant</h6>
                  <p className="text-accent/60">Organize your cash flow</p>
                </div>
              </div>
            </div>
          </RevealAnimation>
