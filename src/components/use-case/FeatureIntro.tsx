      ...
      <div className="main-container">
        <div className="space-y-3 mb-14 md:mb-[70px] max-w-[660px] mx-auto text-center">
          ...
          <RevealAnimation delay={0.2}>
            <p>
              Sumu is designed to serve a wide range of teams and industries. Whether you’re managing data, scaling
              operations, optimizing finances, or streamlining customer experiences—Sumu is the platform that grows with
              you.
            </p>
          </RevealAnimation>
        </div>
