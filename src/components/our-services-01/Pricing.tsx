      ...
      <div className="main-container space-y-[70px]">
        <div className="flex flex-col items-center text-center">
          <RevealAnimation delay={0.1}>
            <span className="badge badge-yellow-v2 mb-5">{t('productsPage.pricing.badge')}</span>
          </RevealAnimation>
          <RevealAnimation delay={0.2}>
            <h2 className="max-w-[650px] mx-auto mb-8">{t('productsPage.pricing.title')}</h2>
          </RevealAnimation>
            ...
            <div className="bg-white dark:bg-background-7 rounded-[160px] py-6 px-14 relative">
              <RevealAnimation delay={1} duration={1} direction="up" offset={200}>
                <span className="absolute z-11 -right-6 -top-2.5 bg-secondary dark:bg-accent text-accent dark:text-secondary inline-block font-normal capitalize text-tagline-2 px-3.5 py-1.5 shadow-xs rounded-[36px] rotate-[20deg] w-[90px]">
                  {t('productsPage.pricing.save40')}
                </span>
              </RevealAnimation>
              <label className="relative inline-flex items-center cursor-pointer z-[10]">
                <span className="mr-2.5 text-base text-secondary dark:text-accent font-normal">
                  {t('productsPage.pricing.monthly')}
                </span>
                <input
                  type="checkbox"
                  id="priceCheck"
                ...
                <span className="ms-2.5 text-base text-secondary dark:text-accent font-normal">
                  {t('productsPage.pricing.yearly')}
                </span>
              </label>
            </div>
          </RevealAnimation>
          ...
          <div className="flex max-lg:flex-col items-center gap-8">
            ...
            <RevealAnimation delay={0.4}>
              <div className="bg-background-3 dark:bg-background-7 flex-1 p-8 rounded-[20px] lg:max-w-[420px] max-w-full w-full">
                <h3 className="mb-2 font-normal text-heading-5">{t('productsPage.pricing.plans.simplified.name')}</h3>
                <p className="mb-6 max-w-[250px]">{t('productsPage.pricing.plans.simplified.tagline')}</p>
                <div className="price-month mb-7">
                  ...
                  <p className="text-secondary dark:text-accent">
                    {isAnnual ? t('productsPage.pricing.perYear') : t('productsPage.pricing.perMonth')}
                  </p>
                </div>
                ...
                <ul className="relative list-none space-y-2.5">
                  <li className="flex items-center gap-2.5">
                    ...
                    <span className="text-secondary dark:text-accent/80 font-normal text-tagline-1">
                      {t('productsPage.pricing.plans.simplified.features.singlePayment')}
                    </span>
                  </li>
                  <li className="flex items-center gap-2.5">
                    <svg
                    ...
                    <span className="text-secondary/60 dark:text-accent/40 font-normal text-tagline-1">
                      {t('productsPage.pricing.plans.simplified.features.sellingOwnItems')}
                    </span>
                  </li>
                  <li className="flex items-center gap-2.5">
                    <svg
                    ...
                    <span className="text-secondary/60 dark:text-accent/40 font-normal text-tagline-1">
                      {t('productsPage.pricing.plans.simplified.features.powerfulIntegration')}
                    </span>
                  </li>
                </ul>
              </div>
            ...
            <RevealAnimation delay={0.6}>
              <div className="p-2.5 rounded-[20px] flex-1 bg-[url('/images/home-page-2/price-bg.png')] bg-no-repeat bg-center bg-cover max-lg:w-full">
                <div className="bg-white dark:bg-black p-8 rounded-xl">
                  <h3 className="mb-2.5 font-normal text-heading-5">{t('productsPage.pricing.plans.basic.name')}</h3>
                  <p className="mb-6 max-w-[250px]">{t('productsPage.pricing.plans.basic.tagline')}</p>
                  <div className="price-month mb-7">
                    <h4 className="text-heading-4 font-normal">
                  ...
                  <ul className="relative list-none space-y-2.5">
                    <li className="flex items-center gap-2.5">
                      ...
                      <span className="text-secondary dark:text-accent/80 font-normal text-tagline-1">
                        {t('productsPage.pricing.plans.basic.features.unlimitedBandwidth')}
                      </span>
                    </li>
                    <li className="flex items-center gap-2.5">
                      <svg
                      ...
                      <span className="text-secondary dark:text-accent/80 font-normal text-tagline-1">
                        {t('productsPage.pricing.plans.basic.features.promotionalTools')}
                      </span>
                    </li>
                    <li className="flex items-center gap-2.5">
                      <svg
                      ...
                      <span className="text-secondary dark:text-accent/80 font-normal text-tagline-1">
                        {t('productsPage.pricing.plans.basic.features.singlePayment')}
                      </span>
                    </li>
                    <li className="flex items-center gap-2.5">
                      <svg
                    ...
                    <li className="flex items-center gap-2.5">
                      ...
                      <span className="text-secondary/60 dark:text-accent/40 font-normal text-tagline-1">
                        {t('productsPage.pricing.plans.basic.features.sellingOwnItems')}
                      </span>
                    </li>
                    <li className="flex items-center gap-2.5">
                      <svg
                      ...
                      <span className="text-secondary/60 dark:text-accent/40 font-normal text-tagline-1">
                        {t('productsPage.pricing.plans.basic.features.powerfulIntegration')}
                      </span>
                    </li>
                  </ul>
                </div>
            ...
            <RevealAnimation delay={0.8}>
              <div className="bg-background-3 dark:bg-background-7 flex-1 p-8 rounded-[20px] lg:max-w-[420px] max-w-full w-full">
                <h3 className="mb-2 font-normal text-heading-5">{t('productsPage.pricing.plans.enhanced.name')}</h3>
                <p className="mb-6 max-w-[250px]">{t('productsPage.pricing.plans.enhanced.tagline')}</p>
                <div className="price-month mb-7">
                  <h4 className="text-heading-4 font-normal">
                    $<span>{isAnnual ? '4420.00' : '37.00'}</span>
                  </h4>
                ...
                <ul className="relative list-none space-y-2.5">
                  <li className="flex items-center gap-2.5">
                    ...
                    <span className="text-secondary dark:text-accent/80 font-normal text-tagline-1">
                      {t('productsPage.pricing.plans.enhanced.features.sellingOnOwnConditions')}
                    </span>
                  </li>
                  <li className="flex items-center gap-2.5">
                    <svg
                    ...
                    <span className="text-secondary dark:text-accent/80 font-normal text-tagline-1">
                      {t('productsPage.pricing.plans.enhanced.features.seamlessIntegrations')}
                    </span>
                  </li>
                  <li className="flex items-center gap-2.5">
                    <svg
                    ...
                    <span className="text-secondary/60 dark:text-accent/80 font-normal text-tagline-1">
                      {t('productsPage.pricing.plans.enhanced.features.realTimeStreaming')}
                    </span>
                  </li>
                </ul>
              </div>
