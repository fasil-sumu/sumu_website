          ...
          <div className="text-center space-y-4 mb-14">
            ...
            <RevealAnimation delay={0.2}>
              <p className="md:max-w-full sm:max-w-[560px] max-w-[390px] mx-auto">
                Sumu brings you borderless, trustless finance—powered by DeFi. Access global tools with zero middlemen
                and full control.
              </p>
            </RevealAnimation>
          </div>
            ...
            <div className="flex items-center justify-center sm:gap-4 gap-y-4 sm:flex-row flex-col">
              ...
              <RevealAnimation delay={0.9} direction="right" offset={50}>
                <div className="text-center sm:text-left">
                  ...
                  <p className="text-tagline-3">Use Sumu for smarter decisions.</p>
                </div>
              </RevealAnimation>
            </div>
          </div>
        ...
        <div className="mt-14 relative z-30">
          ...
          <RevealAnimation delay={1}>
            <figure className="max-w-[1251px] mx-auto w-full">
              <Image
                src={heroImage}
                alt="Sumu Hero Dashboard"
                className="size-full object-cover dark:hidden"
                priority
              />
              <Image
                src={heroImageDark}
                alt="Sumu Hero Dashboard Dark Mode"
