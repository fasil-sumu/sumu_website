      ...
      <div className="main-container">
        <div className="grid grid-cols-12 xl:gap-[90px] lp:gap-[100px] lg:gap-[70px] gap-y-16 items-center">
          <div className="col-span-12 lg:col-span-6">
            <div className={`lg:text-${isRTL ? 'right' : 'left'} text-center`}>
              <div className="space-y-3">
                <RevealAnimation delay={0.1}>
                  <h2 className="max-w-[587px] mx-auto lg:mx-0">{t('homepage08.features.title')}</h2>
                </RevealAnimation>
                <RevealAnimation delay={0.2}>
                  <p className="xl:max-w-full max-w-[500px] mx-auto lg:mx-0">{t('homepage08.features.description')}</p>
                </RevealAnimation>
              </div>
                ...
                <RevealAnimation delay={0.3}>
                  <div className="xl:max-w-[288px] flex-1 bg-background-1 dark:bg-background-6 p-6 rounded-2xl space-y-3">
                    ...
                    <p className="flex items-center gap-0.5 text-secondary justify-center dark:text-accent text-heading-6 font-normal text-center">
                      {isRTL ? (
                        <span className="inline-block">٪{displayNumber(99.9)}</span>
                      ) : (
                        <NumberAnimation number={99.9} speed={2000} interval={200} rooms={3} heightSpaceRatio={2.6}>
                          99.9%
                        </NumberAnimation>
                      )}
                      {t('homepage08.features.projectCompleted')}
                    </p>
                  </div>
                </RevealAnimation>
                <RevealAnimation delay={0.4}>
                  <div className="xl:max-w-[288px] flex-1 bg-background-1 dark:bg-background-6 p-6 rounded-2xl space-y-3">
                    ...
                    <p className="flex items-center justify-center gap-1 text-secondary dark:text-accent text-heading-6 font-normal text-center">
                      {isRTL ? (
                        <span className="inline-block">٪{displayNumber(98)}</span>
                      ) : (
                        <NumberAnimation number={98} speed={2000} interval={200} rooms={2} heightSpaceRatio={2.6}>
                          98%
                        </NumberAnimation>
                      )}
                      {t('homepage08.features.satisfiedClients')}
                    </p>
                  </div>
                </RevealAnimation>
              </div>
                  ...
                  <figure
                    ...
                    <figcaption className="flex justify-between gap-2">
                      <span className="text-tagline-1 font-normal dark:text-accent">
                        {t('homepage08.features.todayRevenue')}
                      </span>
                      <span className="text-lg flex items-center font-medium leading-[1.5] text-secondary dark:text-accent">
                        ...
                        {isRTL ? (
                          <span className="inline-block">{displayNumber(53224)}</span>
                        ) : (
