...
import LightLogo from '@public/images/shared/logo-removebg.png';
import Image, { StaticImageData } from 'next/image';
import Link from 'next/link';
import { FC, useState, useEffect } from 'react';
import { useTranslation } from 'react-i18next';
import ThemeToggle from '../shared/ThemeToggle';
import FooterDivider from '../shared/footer/FooterDivider';
...
const FooterThree: FC<FooterThreeProps> = ({ bgGradientImg, className, gradientClassName }) => {
  ...
  return (
    <footer
      className={cn('dark:bg-background-8 relative overflow-hidden bg-white', className)}
      dir={isRTL ? 'rtl' : 'ltr'}>
      <div className="main-container">
        ...
        <div className="grid grid-cols-12 justify-between gap-x-4 gap-y-12 pt-12 pb-12 sm:gap-y-16 sm:pt-16 sm:pb-16 lg:gap-x-8 xl:gap-x-0 xl:pt-[100px]">
          <div className="col-span-12 lg:col-span-4">
            <RevealAnimation delay={0.05}>
              <div className="xl:max-w-[306px]">
                <figure>
                  <Image src={LightLogo} className="dark:hidden w-[120px] h-auto" alt="Sumu" />
                  <Image src={DarkLogo} className="hidden dark:block w-[120px] h-auto" alt="Sumu" />
                </figure>
                <p className="text-secondary dark:text-accent mt-4 mb-7">{t('homepage08.footer.description')}</p>
