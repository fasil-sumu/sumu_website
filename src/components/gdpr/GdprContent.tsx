    ...
    <section className="pt-[100px] pb-[200px]">
      <div className="main-container">
        <div className="space-y-[70px]">
          ...
          <RevealAnimation delay={0.3}>
            <div className="space-y-3">
              <h3 className="text-heading-4">How Sumu Implements GDPR</h3>
              <p>
                Sumu has always prioritized user data privacy, even before GDPR came into effect. Our core practices
