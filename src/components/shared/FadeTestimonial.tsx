...
export const slides = [
  {
    ...
    text: 'Sumu gave us the clarity and control we needed to proactively manage risk. Their platform is intuitive and powerful.',
  },
  {
    id: 2,
    ...
    text: 'With Sumu, we reduced compliance headaches and improved our audit readiness. The support team is fantastic!',
  },
  {
    id: 3,
    name: 'John Smith',
    ...
    text: 'We now have a single source of truth for risk data. Sumu made collaboration between departments effortless.',
  },
];
