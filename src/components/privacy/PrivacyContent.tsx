        ...
        <div className="space-y-[75px] privacy-policy">
          ...
          <div className="space-y-2">
            ...
            <RevealAnimation delay={0.2}>
              <p>
                <span className="text-secondary dark:text-accent">Sumu</span> is a product operated by
                <span className="text-secondary dark:text-accent">Sumu Technologies LLC</span>. We specialize in
